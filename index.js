...
// Update user profile - FIXED: Now supports both POST and PUT methods
app.put('/api/user/profile', verifyToken, async (req, res) => {
  await updateProfileHandler(req, res);
});

// Add POST method for profile update to match client expectations
app.post('/api/user/profile', verifyToken, async (req, res) => {
  await updateProfileHandler(req, res);
});

// Profile update handler function (used by both PUT and POST)
...
// ===== FIXED: FUNCTION TO SAVE BOT RESPONSE TO SUPABASE =====
...
server.listen(port, () => {
  ...
  console.log(`   GET /api/user/profile - Get current user profile (REQUIRES TOKEN)`);
  console.log(`   POST /api/user/profile - Update user profile (REQUIRES TOKEN - FIXED!)`);
  console.log(`   PUT /api/user/profile - Update user profile (REQUIRES TOKEN - FIXED!)`);
  console.log(`   GET /api/user/profile/:username - Get user profile (public)`);
